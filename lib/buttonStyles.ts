...
export const buttonStyles = {
  ...
  photoRemove:
    'app-btn flex min-h-11 min-w-11 items-center justify-center rounded-full bg-black/65 px-3 text-xs font-semibold text-white ring-1 ring-white/20',
  photoCaptureTile: `${PRESSABLE_3D} lifexp-tile-3d flex aspect-[3/4] flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-accent/45 bg-gradient-to-b from-surface via-accent-soft/25 to-slate-100/90 px-3 text-center text-sm font-semibold text-accent ring-1 ring-accent/15 hover:border-accent hover:from-white hover:via-accent-soft/40 hover:to-slate-200/90 disabled:opacity-50 dark:border-accent/50 dark:from-slate-900 dark:via-accent-soft/15 dark:to-slate-950 dark:text-accent`,
  caseListItem: `${PRESSABLE_3D} lifexp-tile-3d flex w-full items-center gap-3.5 rounded-2xl border-2 border-border bg-gradient-to-b from-surface via-slate-50 to-slate-200/80 px-4 py-3.5 text-left ring-1 ring-border/25 hover:border-accent/70 dark:border-slate-600 dark:from-slate-800 dark:via-slate-800 dark:to-slate-950`,
  caseDoneToggle: `${btn3d} flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border-2 text-sm ${surface3d}`,
