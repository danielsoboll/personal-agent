...
export const PLUS_PRICE_HERO_CLASS =
  'rounded-2xl border-2 border-amber-300/75 bg-gradient-to-b from-amber-50 via-orange-50/85 to-amber-100/65 px-4 py-3 text-center shadow-sm ring-1 ring-amber-200/45 dark:border-amber-700/50 dark:from-amber-950/35 dark:via-orange-950/25 dark:to-amber-950/30 dark:ring-amber-900/35'

export const PLUS_PRICE_INLINE_CLASS =
...
export const PLUS_SHEET_SURFACE_CLASS =
  'rounded-t-3xl border border-amber-200/70 bg-gradient-to-b from-amber-50/90 via-surface to-surface px-5 shadow-2xl dark:border-amber-900/45 dark:from-amber-950/30 dark:via-surface dark:to-surface'

export const PLUS_SHEET_SURFACE_ACTIVE_CLASS =
  'rounded-t-3xl border border-emerald-300/60 bg-gradient-to-b from-emerald-50/85 via-surface to-surface px-5 shadow-2xl dark:border-emerald-800/45 dark:from-emerald-950/30 dark:via-surface dark:to-surface'
